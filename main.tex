...
% 自定义颜色
\definecolor{primary_color}{RGB}{0, 37, 84}    % 参考学校官网www.upc.edu.cn
\definecolor{secondary_color}{RGB}{0, 37, 84}
...
% 学院
\newcommand{\school}{计算机科学与技术学院 | College of Computer Science and Technology} 
...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        % 邮箱
        \faEnvelope \quad \href{mailto:youremail@s.upc.edu.cn}{youremail@s.upc.edu.com}
        \hspace{4em}
        % 手机号
...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=west](school_logo) at (header.west){
            \hspace{0.5cm}
            \includegraphics[width=0.25\textwidth]{images/banner-white.png}
        };
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.05] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/logo_big.jpg}
        };
    \end{tikzpicture}
    ...
    {\large \textbf{中国石油大学（华东）}}，专科 \hfill 2000年9月--2010年6月
    \begin{itemize}
        \item 你的学院，你的专业
    ...
    \vspace{0.5em}
    {\large \textbf{中国石油大学（华东）}}，本科 \hfill 2010年9月--2020年6月
    \begin{itemize}
        \item 你的学院，你的专业
        \item \textbf{主修课程}：课程1、课程2、课程3、课程4\ 等。
    ...
    \vspace{0.5em}
    {\large \textbf{中国石油大学（华东）}}，硕士 \hfill 2020年9月--至今
    \begin{itemize}
